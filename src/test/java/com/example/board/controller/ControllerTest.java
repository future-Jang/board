...
//가짜MVC
    ...
    @BeforeEach
    public void setUp(){
        //가짝 MVC에 WebApplicationContext를 전달한 후 환경을 생성한다.
        mockMvc = MockMvcBuilders.webAppContextSetup(webApplicationContext).build();
    }

    @Test
    public void testList() throws Exception{  //get 방식의 get
    ...
    public void testModify() throws Exception {
        String result = mockMvc.perform(MockMvcRequestBuilders.post("/board/modify")
                .param("bno", "6")
                .param("title", "테스트 수정 제목1")
                .param("content", "테스트 수정 내용1")
    ...
    public void testGoModify() throws Exception{
        String result = mockMvc.perform(MockMvcRequestBuilders.get("/board/modify").param("bno","21"))
                .andReturn().getModelAndView().getModelMap().toString();
